...
public class ExerciseListViewTest extends AbstractViewTest {
    ...
    public void testListContainsTwoElements() {
        Content html = exerciseList.render(null, pagedExerciseList, 1, "", "", new ArrayList<>());
    ...
    public void testTitleFilterExistInInputField() {
        Content html = exerciseList.render(null, pagedExerciseList, 1, "XXX", "", new ArrayList<>());
        assertEquals("text/html", html.contentType());
    ...
    public void testTagFilterExistInInputField() {
        Content html = exerciseList.render(null, pagedExerciseList, 1, "", "ABC,DEF", new ArrayList<>());
        assertEquals("text/html", html.contentType());
    ...
    public void testPaginationPageZeroPrevDisabled() {
        Content html = exerciseList.render(null, pageZero, 1, "", "", new ArrayList<>());
        assertEquals("text/html", html.contentType());
    ...
    public void testPaginationPageOnePrevNotDisabled() {
        Content html = exerciseList.render(null, pageOne, 1, "", "", new ArrayList<>());
        assertEquals("text/html", html.contentType());
